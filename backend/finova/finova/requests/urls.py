...
from .views import ListRequestsView,ListRecentRequestsView,CreateRequestView,GetRequestView,CastVote,AdminMarkRequestView
...
urlpatterns = [
    ...
    path('list-recent/',ListRecentRequestsView.as_view(), name='list_recent_requests'),
]