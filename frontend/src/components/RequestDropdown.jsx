...
const RequestDropdown = ({ value, options, onChange }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={dropRef}
        className="absolute z-50 top-full right-0 mt-1 min-w-full bg-foreground border border-outline rounded-xl overflow-hidden h-0 opacity-0 shadow-xl"
      >
